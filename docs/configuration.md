...
FM_ARM_REAP_WAIT=       # seconds fm-watch-arm --restart waits for the TERM'd predecessor before refusing loudly; unset derives max(FM_POLL, 2 * FM_CREW_STATE_NM_TIMEOUT) + 5, never below 5 (docs/watcher-continuity.md)
